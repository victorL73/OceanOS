...
<head>
  ...
  <meta name="description" content="OceanOS - Portail CRM central pour Flowcean, Invocean, Stockcean, Mobywork, NautiPost, NautiCloud, Formcean, Nautisign et Naviplan.">
...
<body>
  <main class="shell" data-state="loading">
    ...
    <section class="dashboard-view hidden" id="dashboard-view">
      ...
      <section class="overview">
        ...
        <p class="muted">Votre session OceanOS est partagee avec Flowcean, Invocean, Stockcean, Mobywork, NautiPost, NautiCloud, Formcean, Nautisign et Naviplan.</p>
      </section>
  ...
  <script defer src="assets/guard.js?v=20260428-naviplan"></script>
  <script src="assets/oceanos.js?v=20260428-naviplan"></script>
</body>
</html>
